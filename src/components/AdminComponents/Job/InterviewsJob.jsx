...
const InterviewsJob = () => {
  ...
  <div className="d-flex justify-content-between align-items-center mb-4">
    <h4 className="mb-0">Interview Schedule</h4>
    <div className="header-actions d-flex align-items-center" style={{width:"300px"}}>
      ...
      <table className="table">
        ...
        <tbody>
          <tr>
            ...
            <td>
              <span className="badge-interview badge-scheduled">Scheduled</span>
            </td>
          </tr>
          <tr>
            <td>
